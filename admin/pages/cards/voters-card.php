        ...
        <div class="row">
            ...
            <div class="col-sm-5 px-4 border shadow-sm mt-5 rounded pt-3">
                <div class="p-0 m-0 col-sm topper">
                   ...
                   <p class="text-center p-0 m-0">INDEPENDENT NATIONAL ELECTORAL COMMISSION</p>
                   <p class="text-center p-0 m-0" style="font-size: 15px;">VOTER'S CARD</p>
                </div>

                <div class="row">
                    <p class="personId">A<?php echo $serial_no; ?></p>
                <div class="col-sm-5">
            ...
            <div class="col-sm-5 px-4 border shadow-sm mt-5 rounded pt-3">
                ...
                <div class="bottom">
                    ...
                    <div class="paragraphs">
                        ...
                        <div class="row ">
                            <div class="col-sm-6">
                                <p><span class="batch">BATCH: <?php echo $unique_code; ?></span></p>
                            </div>
